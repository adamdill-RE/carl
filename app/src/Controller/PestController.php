 ...
 *
 * **ONE STATEMENT, WHOLE CATALOGUE, NO PAGINATION.** Seventy-odd rows of
 * prose is a page somebody scrolls and their browser searches, and the search
 * box here narrows it further. Paginating it would mean a second statement
 * and a worse screen.
 *
